...
public class ChatController extends Observer {
    ...
    public void initialize() {
        whoColumn.setCellValueFactory(new PropertyValueFactory<DTOchat, String>("userFrom"));
        textColumn.setCellValueFactory(new PropertyValueFactory<DTOchat, String>("message"));
    ...
    public void handleBtnReply(ActionEvent actionEvent) {
    ...
    public void handleBtnReplyAll(ActionEvent actionEvent) {
        DTOchat selected = tableView.getSelectionModel().getSelectedItem();
        if(selected!=null){
            if(!txtMessage.getText().isEmpty()){
